...
const Navbar = () => {
  const { activeMenu, setActiveMenu, isClicked, handleClick, screenSize,
            ...
            onClick={() => handleClick('userProfile')}>
              <img
                ...
                <p>
                  ...
                  <span className='text-gray-400 font-bold ml-1 text-14'>Grégory</span>
                </p>
                <MdKeyboardArrowDown
                  className='text-gray-400 font-bold text-14' />
          </div>
        </TooltipComponent>
